function output = MCS_Integrated_SFI_roi_Spectrum(analyVar, indivDataset, avgDataset)
    ...
    indivDataset = param_extract_sfi_integral_roi_select(analyVar, indivDataset);
    
    %% plot the data
    plot_MCS_Integrated_SFI_roi_Spectrum(analyVar, indivDataset);
