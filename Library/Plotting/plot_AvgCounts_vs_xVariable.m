function [ output_args ] = plot_AvgCounts_vs_xVariable(analyVar, indivDataset, xVariable, legendVariable)
...
%     NormTotalPopNonPeak_AvgSpectra  = cat(4,NormTotalPopNonPeak_AvgSpectra,indivDataset{bIndex}.NormTotalPopNonPeak_AvgSpectra);
    RelNormAvgSpectra            = cat(ArrayDim+1,RelNormAvgSpectra,indivDataset{mbIndex}.RelNormAvgSpectra);
...
% %         set(axHan{subplotIndex},'Position', [.1 .27 .75 .65]);
