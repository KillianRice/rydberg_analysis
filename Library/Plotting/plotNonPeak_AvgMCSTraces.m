function [ output_args ] = plotNonPeak_AvgMCSTraces( analyVar,indivDataset )
...
for mbIndex = 1:analyVar.numBasenamesAtom
    for bIndex = 1:indivDataset{mbIndex}.CounterAtom
        AvgSpectra{bIndex} = analyVar.NonPeak_AvgSpectra{bIndex};
...
%% single plot of raw data    
    ...
    FigHandle = figure;
    set(FigHandle, 'Position', [850, 100, 750, 750]);
