function [nrow, ncol] = optiSubPlotNum(n, imagesz)
% Notes: Exchanged Jim's optiSubPlotNum with this one originally called
% arrange_subplots.m written by Geng Zhang but changed the function name so
% that other code should still work. 
% Downloaded from http://www.mathworks.com/matlabcentral/fileexchange/40024-arrange-subplots#comments
